...
// import imported_image_devices from './MiscJV/Icons/devices.png'
// import imported_image_empty   from './MiscJV/Icons/empty.png'
// import imported_image_cog     from './MiscJV/Icons/cog.png'

import imported_image_devices from './devices.png'
import imported_image_empty   from './empty.png'
import imported_image_cog     from './cog.png'

function get_b64_src () {
...
const image_devices = get_uri_from_imported_image (imported_image_devices)
const image_empty   = get_uri_from_imported_image (imported_image_empty)
const image_cog     = get_uri_from_imported_image (imported_image_cog)
const b64_src       = get_b64_src()

export default {image_devices, image_empty, image_cog, b64_src}